...
public class Snack extends javax.swing.JFrame {
    ...
    jTextArea1.setText("CHANGNOI "+"= "+qty);
    ...
    double price = 5.0; // Example price per item
    double totalPrice = qty * price;
    jTextArea1.setText("CHOKICHOKI "+"= "+qty);
    jTextField5.setText(String.valueOf(totalPrice)+" Bath");
    updateInformation();
    ...
    double price1 = qty1 * 10.0;  // คำนวณราคาของ Changnoi
    double price2 = qty2 * 20.0;  // คำนวณราคาของ Lays
    double price3 = qty3 * 20.0;  // คำนวณราคาของ Taro
    double price4 = qty4 * 5.0;  // คำนวณราคาของ ChokiChoki 
    ...
    appendProductInfo(info, jTextField1, "CHOKICHOKI");
    appendProductInfo(info, jTextField2, "CHANGNOI");
    appendProductInfo(info, jTextField3, "LAYS");
    appendProductInfo(info, jTextField4, "TARO");
