...
public class HHItem extends javax.swing.JFrame {

    /**
     * Creates new form HHItem
     */
    public HHItem() {
        initComponents();
    }
    ...
    double price = 20.0; // Example price per item
    double totalPrice = qty * price;
    jTextArea1.setText("SOAP "+"= "+qty);
    ...
    double price = 109.0; // Example price per item
    double totalPrice = qty * price;
    jTextArea1.setText("PROTEX "+"= "+qty);
    jTextField5.setText(String.valueOf(totalPrice)+" Bath");
    updateInformation();
    ...
    double price = 40.0; // Example price per item
    double totalPrice = qty * price;
    jTextArea1.setText("OMO "+"= "+qty);
    jTextField5.setText(String.valueOf(totalPrice)+" Bath");
    updateInformation();
    ...
    double price = 40.0; // Example price per item
    double totalPrice = qty * price;
    jTextArea1.setText("SUNLIGHT "+"= "+qty);
    jTextField5.setText(String.valueOf(totalPrice)+" Bath");
    updateInformation();
    ...
    double price1 = qty1 * 20;  // คำนวณราคาของ Soap
    double price2 = qty2 * 109;  // คำนวณราคาของ Protex
    double price3 = qty3 * 40;  // คำนวณราคาของ Omo
    double price4 = qty4 * 40;  // คำนวณราคาของ Sunlight  
    ...
    appendProductInfo(info, jTextField1, "SUNLIGHT");
    appendProductInfo(info, jTextField2, "SOAP");
    appendProductInfo(info, jTextField3, "PROTEX");
    appendProductInfo(info, jTextField4, "OMO");
    
    jTextArea1.setText(info.toString().trim());
}
...
private void appendProductInfo(StringBuilder info, JTextField textField, String productName) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HHItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
