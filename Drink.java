...
public class Drink extends javax.swing.JFrame {
    ...
    double price = 26.0; // Example price per item
    double totalPrice = qty * price;
    jTextArea1.setText("MINERAL "+"= "+qty);
    jTextField5.setText(String.valueOf(totalPrice)+" Bath");
    updateInformation();
    ...
    double price = 30.0; // Example price per item
    double totalPrice = qty * price;
    jTextArea1.setText("MILK "+"= "+qty);
    jTextField5.setText(String.valueOf(totalPrice)+" Bath");
    updateInformation();
    ...
    double price = 25.0; // Example price per item
    double totalPrice = qty * price;
    jTextArea1.setText("SPRITE "+"= "+qty);
    jTextField5.setText(String.valueOf(totalPrice)+" Bath");
    updateInformation();
    ...
    double price1 = qty1 * 10.0;  // คำนวณราคาของ Pepsi 10
    double price2 = qty2 * 26.0;  // คำนวณราคาของ Mineral 26
    double price3 = qty3 * 30.0;  // คำนวณราคาของ Milk 30
    double price4 = qty4 * 25.0;  // คำนวณราคาของ Sprite 25
    ...
    appendProductInfo(info, jTextField1, "SPRITE");
    appendProductInfo(info, jTextField2, "PEPSI");
    appendProductInfo(info, jTextField3, "MINERAL");
    appendProductInfo(info, jTextField4, "MILK");
